...
**Status: In progress**
- ✅ Extend input support beyond plain text/markdown (HTML supported).
- ✅ Improve extraction fidelity while preserving offsets and contextual metadata.
- ⚠️ Introduce additional scanners aligned with newly supported formats (only hidden HTML currently).
